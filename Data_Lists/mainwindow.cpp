...
**************************************************************************/
void MainWindow::create_listHandler
    (LinkedList<std::string> temp)       //IN - LinkedList object of type string
{
    //data table
    QString tempQString;         //IN - temp QString
    string tempString;           //IN - temp string
...
*   Returns nothing
**************************************************************************/
void MainWindow::isItemChecked() noexcept(false)
{
