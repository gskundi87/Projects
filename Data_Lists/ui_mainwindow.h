...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        displayOutput->setObjectName(QString::fromUtf8("displayOutput"));
        ...
        intButton->setObjectName(QString::fromUtf8("intButton"));
