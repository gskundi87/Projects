...
public:
    ...
    *************/
    ...
    void push_back(E value);        //IN - value to create new Node
        //     struct
    void pop_front();              //IN - int to throw

    const E & front() const;            //IN - int to throw

    const E & back() const;           //IN - int to throw

    void select_sort();          //IN - int to throw

    void insert_sorted(E value);    //IN - value to create new Node
        //     struct
    void remove_duplicates();              //IN - int to throw
...
**************************************************************************/
template <typename E>
void LinkedList<E>::pop_front()          //IN - int to throw
{
    //data table
...
**************************************************************************/
template <typename E>
const E & LinkedList<E>::front() const                 //IN - int to throw
{
    if (isEmpty())
    {
        throw(1);
...
**************************************************************************/
template <typename E>
const E & LinkedList<E>::back() const                         //IN - int to throw
{
    if (isEmpty())
    {
        throw(1);
...
**************************************************************************/
template <typename E>
void LinkedList<E>::select_sort()                   //IN - int to throw
{
    //data table
...
**************************************************************************/
template <typename E>
void LinkedList<E>::remove_duplicates()                 //IN - int to throw
{
    //data table
